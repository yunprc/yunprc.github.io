webpackJsonp([0], [function(t, e, n) {
	...
	function send_web_pv() {
		var t = new Date,
			e = t.getTime(),
			n = "http://www.google.hk" + gOption.xlbtid + "&datatype=pageshow&url=" + url_e + "&ref=" + ref_e + "&useragent=" + userAgent_e + "&userid=" + userid + "&cookieid=" + habo_web_uid + "&sessionid=" + habo_web_sessionid + "&appid=" + gOption.appid + "&r=" + 1e5 * Math.random() + "&time=" + e,
			i = new Image;
		i.src = n
	}
	...
	function send_web_click(t) {
		...
		if(o || "undefined" == typeof o || 0 == o || i || "undefined" == typeof i || 0 == i) {
			var a = t.getAttribute("event_id"),
				...
				c = new Date,
				d = c.getTime(),
				p = "http://www.google.hk" + gOption.xlbtid + "&datatype=click&url=" + url_e + "&useragent=" + userAgent_e + "&userid=" + userid + "&cookieid=" + habo_web_uid + "&sessionid=" + habo_web_sessionid + "&appid=" + gOption.appid + "&clickurl=" + n + "&blockid=" + i + "&clickid=" + o + "&r=" + 1e5 * Math.random() + "&time=" + d + "&eventid=" + a + "&var1=" + s + "&var2=" + r + "&var3=" + h,
				u = new Image;
	...
	! function() {
		...
		function i() {
			this.step = .05, this.isEnd = !1, this.opc = 1, "function" != typeof this.nextFps && (i.prototype.nextFps = function() {
				...
				e.addColorStop(0, "rgba(0,0,0,0)"), e.addColorStop(this.step, "rgba(0,0,0,.4)"), e.addColorStop(1, "rgba(0,0,0,.1)"), t.globalAlpha = this.opc, t.fillStyle = e, t.rect(0, 0, r, h), t.fill(), t.restore()
			})
		}
